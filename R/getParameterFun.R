...
function(n,parameter) {
    ...
    tavoleA6 = data.frame (
        ...
        A2    = c(NA, 1.881,1.023,0.729,0.577,0.483,0.419,0.373,0.337,0.308,0.285,0.266,0.249,0.235,0.223,0.212,0.203,0.194,0.187,0.18,0.173,0.167,0.162,0.157,0.153), # this is a patch: 2.659 is when sg=1, but on montgomery tables it is undefined
